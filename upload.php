...
if (isset($_POST['x'])){
    ...
    if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){
        ...
        imagejpeg($dst_r, "assets/images/profile_pics/defaults/".$finalname."n.jpeg", 90);
        $newImg = "assets/images/profile_pics/defaults/".$finalname."n.jpeg";
        $set_img = mysqli_query($con, "UPDATE users SET profile_pic='$newImg' WHERE username='$current_user'");
